...
from users.models import Profile, Friend, ChatMessage
...
def home(request):
    ...
    return render(request, 'faceweb/home.html', context)


class PostListView(ListView):
    model = Post
    template_name = 'faceweb/home.html'  # <app>/<model>_<viewtype>.html
...
class UserPostListView(ListView):
    model = Post
    template_name = 'faceweb/user_posts.html'  # <app>/<model>_<viewtype>.html
    context_object_name = 'posts'
    paginate_by = 5
...
def about(request):
    return render(request, 'faceweb/about.html', {'title': 'About'})



from users.models import ChatMessage, Profile, Friend
...
def index(request):
    ...
    return render(request, "faceweb/index.html", context)
...
def detail(request,pk):
    ...
    return render(request, "faceweb/detail.html", context)
