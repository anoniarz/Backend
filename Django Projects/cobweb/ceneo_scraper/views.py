...
from .functions import delete_from_db, link_to_id, try_or
...
def products(request):
    ...
    if user.is_authenticated:
        user_favourites = request.user.profile.ceneo_favourites.all()
        user_favourites_list = [
    ...
    return render(request, 'ceneo_scraper/products.html', context)


class ProductDetailView(DetailView):
    model = Product
    template_name = 'ceneo_scraper/product_reviews.html'
...
def favourites(request):
    ...
    favourites = profile.ceneo_favourites.all()
    ...
    return render(request, 'ceneo_scraper/favourites.html', context)
